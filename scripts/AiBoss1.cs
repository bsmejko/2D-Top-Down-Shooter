...
public partial class AiBoss1 : CharacterBody2D
{
    // Signals
    ...
    // Enemy Properties
    private float speed = 2000f; // Adjusted speed for testing
    private int hp = 6000;
    ...
    public override void _Ready()
    {
        ...
        AddToGroup("mobs"); // Assign to Enemies group

        // Initialize the death timer
        _deathTimer = new Timer();
        _deathTimer.WaitTime = 1.65f; // 0.33 second delay
    ...
    public void SetPathfindingGrid(AstarPathfinding pathfinding)
    {
        ...
        GD.Print("Pathfinding grid set for AiEnemy1.");
        CheckInitialization();
    }
    ...
    private void CheckInitialization()
    {
        ...
        {
            SetProcess(true);
            GD.Print("AiEnemy1 initialized and ready to move.");
            UpdateTarget();
        }
    }
