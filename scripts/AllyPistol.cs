...
public partial class AllyPistol : Weapon
{
    [Export] public PackedScene BulletScene; // Scene for the bullet

    public override void _Ready()
    {
        WeaponName = "AllyPistol";
        WeaponTexture = GD.Load<Texture2D>("res://assets/Weapons/Pistol(green).png");
        Automatic = false;
        SpreadShot = true;
        Firerate = 0.12f; // Slowest firerate
