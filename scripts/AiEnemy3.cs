...
public partial class AiEnemy3 : CharacterBody2D
{
    // Signals
    ...
    // Enemy Properties
    private float speed = 2500f; // Faster speed for AiEnemy3
    private int hp = 300; // Higher health for AiEnemy3
    ...
    public override void _Ready()
    {
        ...
        _deathTimer.WaitTime = 0.66f; // 1 second delay
    ...
    public void SetPathfindingGrid(AstarPathfinding pathfinding)
    {
        ...
        GD.Print("Pathfinding grid set for AiEnemy3.");
        CheckInitialization();
    }
    ...
    private void CheckInitialization()
    {
        ...
        {
            SetProcess(true);
            GD.Print("AiEnemy3 initialized and ready to move.");
    ...
    public void TakeDamage(int damage)
    {
        ...
        hp -= damage;
        GD.Print($"AiEnemy3 took {damage} damage, remaining health: {hp}");
